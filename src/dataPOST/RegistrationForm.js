export const validateFormData = (data) => {
    ...
    if (data.Mobile_number) {
        ...
        } else if (data.alternate_Mb_Country_code && data.Mobile_number === data.alternate_Mb_Country_code) {
            errors.alternate_Mb_Country_code = "Alternate mobile number must be different from the primary mobile number";
        }
    }
    if (data.alternate_Mb_Country_code) {
        if (!/^\d+$/.test(data.alternate_Mb_Country_code)) {
            errors.alternate_Mb_Country_code = "Alternate mobile number must be numeric";
        }
    }
